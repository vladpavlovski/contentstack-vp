...
export const componentRenderers: ComponentRenderers = {
  hero_banner: (component, key, blogPost) => (blogPost ? null : <Hero1 banner={component.hero_banner} id={key} />),
  section: (component, key) => <Section section={component.section!} id={key} />,
  section_with_buckets: (component, key) =>
    component.section_with_buckets!.bucket_tabular ? (
      <AboutSectionBucket sectionWithBuckets={component.section_with_buckets!} id={key} />
    ) : (
      <SectionBucket section={component.section_with_buckets!} id={key} />
    ),
  from_blog: () => null,
  section_with_cards: (component, key) => <CardSection cards={component.section_with_cards!.cards} id={key} />,
  section_with_html_code: (component, key) => (
    <SectionHtmlCode embedCode={component.section_with_html_code!} id={key} />
  ),
  our_team: (component, key) => <TeamSection ourTeam={component.our_team!} id={key} />,
}
