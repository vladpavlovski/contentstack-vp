...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ...
    className={cn(
      ...
      'px-3 py-1.5 text-sm font-medium outline-none focus:bg-accent',
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ...
    className={cn(
      ...
      'p-1 text-popover-foreground data-[state=open]:animate-in',
  ...
  <MenubarPrimitive.Portal>
    <MenubarPrimitive.Content
      ...
      className={cn(
        ...
        'p-1 text-popover-foreground shadow-md data-[state=open]:animate-in',
